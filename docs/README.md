...
|---|---|---|---|---|
| `SPEC-HARNESS-001` | active | harness | Observable structure and lifecycle of a generated repository harness | [`SPEC-HARNESS-001-generated-project.md`](product-specs/SPEC-HARNESS-001-generated-project.md) |

### Design documents

| ID | Status | Area | Summary | Document |
|---|---|---|---|---|
| `DESIGN-HARNESS-001` | active | harness | Separation between the one-time initializer and independent repository-local runtime | [`DESIGN-HARNESS-001-initializer-and-runtime.md`](design-docs/DESIGN-HARNESS-001-initializer-and-runtime.md) |
